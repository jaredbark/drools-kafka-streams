...
import com.ondot.kafka.sample.drools.applier.MessageObjectRulesApplier;
...
public class KafkaStreamsRunner
{
    ...
    public static KafkaStreams runKafkaStream(PropertiesConfiguration properties) {
        ...
        MessageObjectRulesApplier rulesApplier = new MessageObjectRulesApplier(droolsRuleName);
